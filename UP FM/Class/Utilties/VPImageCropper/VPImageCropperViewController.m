...
- (void)initControlBtn {
    float butHeight=35.0;
    float butWidth=100.0;
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(5, WIN_HEIGHT - butHeight-5, butWidth, butHeight)];
    cancelBtn.backgroundColor = RED_COLOR;
    cancelBtn.titleLabel.textColor = [UIColor whiteColor];
    cancelBtn.layer.cornerRadius=3.0;
    [cancelBtn setTitle:@"取消" forState:UIControlStateNormal];
    [cancelBtn.titleLabel setFont:FONT_16B];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(WIN_WIDTH - butWidth -5, WIN_HEIGHT - butHeight-5, butWidth, butHeight)];
    ...
    [confirmBtn.titleLabel setFont:FONT_16B];
