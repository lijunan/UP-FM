...
- (void)updatePosition {
    ...
    if(string) {
        NSDictionary * tdic = [NSDictionary dictionaryWithObjectsAndKeys:self.stringLabel.font,NSFontAttributeName,nil];
        CGSize  stringSize =[string boundingRectWithSize:CGSizeMake(200, 300) options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:tdic context:nil].size;
